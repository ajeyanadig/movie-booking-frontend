...
class Home extends Component {
    ...
    filterApplyHandler = () => {
        ...
        xhrFilter.open("GET", this.props.baseUrl + "movies" + encodeURI(queryString)); //encodeURI checks queryString for weird non UTF-8 chars like russian symbols and shiz
